    ...
    tours.forEach(function (tour) {
        ...
        const row = `
            ...
            <tr class="group border-b border-slate-100 last:border-0 hover:bg-slate-50 transition-colors">
                ...
                <td class="relative overflow-hidden px-3 py-4 text-left lg:px-5 lg:py-4 lg:text-center">

                    ${mobileBackdrop}

                    <div class="relative z-10 mx-auto min-w-0 max-w-[280px] lg:min-w-[220px]">
                ...
                <td class="whitespace-nowrap bg-slate-50/70 px-2 py-3 text-center lg:bg-transparent lg:px-3 lg:py-4">
